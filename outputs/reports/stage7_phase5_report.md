...
|-------|-----------------|-----------------|-------------|
| LFM2.5-1.2B | 1.2 GB | ~6x KV cache | ? MB engine |
| Llama-3.2-1B | 1.1 GB | ~6x KV cache | ? MB engine |
...
|-------|---------|------------|---------|--------|
| LFM2.5-1.2B | ? | 55.4 | ? | ? MB W4A16 AWQ |
| Llama-3.2-1B | ? | 44.7 | ? | ? MB W4A16 AWQ |
