...
|-------|----------------|---------------|--------------|------|
| LFM2.5-1.2B | 55.4 | N/A | 99.7 t/s | **99.7 t/s** |
| Llama-3.2-1B | 44.7 | N/A | 80.5 t/s | **80.5 t/s** |
...
|-------|-----------------|-----------------|-------------|
| LFM2.5-1.2B | 1.2 GB | ~6x KV cache | 680 MB engine |
| Llama-3.2-1B | 1.1 GB | ~6x KV cache | 580 MB engine |
...
| Model | TRT t/s | Phase 1 t/s | Speedup | Engine |
|-------|---------|------------|---------|--------|
| LFM2.5-1.2B | 99.7 | 55.4 | 1.80x | 680 MB W4A16 AWQ |
| Llama-3.2-1B | 80.5 | 44.7 | 1.80x | 580 MB W4A16 AWQ |

> See [Stage 5 Report](stage5_tensorrt.md)

### Stage 6 — Knowledge Distillation

| Student | Before (Acc) | After (Acc) | Δ | Teacher |
|---------|-------------|------------|---|---------|
| Qwen2.5-0.5B | 26.67% | **53.33%** | +26.66% | meta-llama/Llama-3.1-70B-Instruct-Turbo |
