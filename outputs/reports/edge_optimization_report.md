...
| **XXIII** | MLC-LLM v0.20.0 (TVM-compiled kernels, CUDA graphs, FlashInfer) | ✅ **65.31 t/s** | Llama-3.2-1B q4f16_1, compiled for sm_87 with max_batch_size=1, context 4096. 3 trials: 64.17 / 66.05 / 65.70 t/s. **Mean 65.31 t/s (+7.3% vs 60.88 baseline)**. Memory: 707 MB model + 194 MB KV + 154 MB buffer = 1011 MB IOVM total. CUDA graphs + CUTLASS + FlashInfer active. Container: `dustynv/mlc:0.20.0-r36.4.0`. Note: improvement modest — bandwidth-bound at 1B scale, TVM kernel gains marginal vs IQ4_XS. Next: EAGLE-3 via TRT Edge-LLM (jetson-containers). |
