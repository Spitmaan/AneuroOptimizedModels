...
| **XX** | TensorRT-LLM W4A16 | ✅ Partial (Qwen only) | Qwen2.5-0.5B: **+86% pp, +7.4% tg** (100.87 vs 93.92 t/s). LFM2.5 blocked (SSM arch). Llama: 44.08 t/s (no improvement; gemm_plugin build OOMs on 8 GB Jetson serialization buffer). |
